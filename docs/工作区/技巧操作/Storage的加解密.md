---
title: Storage的加解密的笔记
tags: ["技巧操作"]
创建时间: 星期三, 七月 27日 2022, 8:58:57 晚上
修改时间: 星期四, 七月 28日 2022, 1:23:32 下午
---
#开发技巧 #加解密

# Storage的加解密的笔记

[Storage的加解密](https://mp.weixin.qq.com/s/e8MSFaDwqcCFoxFTMimwPw)

使用`crypto-js`第三库进行加解密。

定义了很多类型属性，进行控制Storage实例。如下代码。
```js
// 区分存储类型 type  
// 自定义名称前缀 prefix  
// 支持设置过期时间 expire  
