import{_ as s,c as n,o as a,a as p}from"./app.e5db1f59.js";const D=JSON.parse('{"title":"JavaScript的继承","description":"","frontmatter":{"title":"JavaScript的继承","date":"2022-07-01T17:08:18.000Z","tags":["JavaScript的继承"]},"headers":[],"relativePath":"工作区/基本知识/JavaScript/JavaScript的继承.md"}'),e={name:"工作区/基本知识/JavaScript/JavaScript的继承.md"},l=p(`<p>#继承 #JavaScript</p><h1 id="javascript的继承的笔记" tabindex="-1">JavaScript的继承的笔记 <a class="header-anchor" href="#javascript的继承的笔记" aria-hidden="true">#</a></h1><p>更新：谢谢大家的支持，最近折腾了一个博客官网出来，方便大家系统阅读，后续会有更多内容和更多优化，<a href="https://link.juejin.cn/?target=https%3A%2F%2Fmuyiy.vip" title="https://muyiy.vip" target="_blank" rel="noreferrer">猛戳这里查看</a></p><p>更新：在常用七种继承方案的基础之上增加了ES6的类继承，所以现在变成八种啦。</p><p>------ 以下是正文 ------</p><h4 id="_1、原型链继承" tabindex="-1">1、原型链继承 <a class="header-anchor" href="#_1、原型链继承" aria-hidden="true">#</a></h4><p>构造函数、原型和实例之间的关系：每个构造函数都有一个原型对象，原型对象都包含一个指向构造函数的指针，而实例都包含一个原型对象的指针。</p><p>继承的本质就是<strong>复制，即重写原型对象，代之以一个新类型的实例</strong>。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">function SuperType() {</span></span>
