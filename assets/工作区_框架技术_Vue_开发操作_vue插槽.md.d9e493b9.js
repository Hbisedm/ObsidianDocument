...
<span class="line"><span style="color:#89DDFF;">&lt;/</span><span style="color:#F07178;">template</span><span style="color:#89DDFF;">&gt;</span></span>
<span class="line"></span>
<span class="line"></span></code></pre></div><h2 id="有一条规则需要记住" tabindex="-1">有一条规则需要记住： <a class="header-anchor" href="#有一条规则需要记住" aria-hidden="true">#</a></h2><ul><li>父组件里的所有内容都是在父级作用域中编译的</li><li>子组件里的所有内容都是在子作用域中编译的</li></ul>`,7),e=[p];function o(c,r,i,D,F,y){return n(),a("div",null,e)}const A=s(t,[["render",o]]);export{C as __pageData,A as default};
