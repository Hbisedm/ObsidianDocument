import{_ as s,c as n,o as a,a as p}from"./app.d0c2f5ea.js";const A=JSON.parse('{"title":"注释细节的笔记","description":"","frontmatter":{"title":"注释细节的笔记","tags":["注释细节"],"创建时间":"星期五, 八月 5日 2022, 1:25:46 下午","修改时间":"星期五, 八月 5日 2022, 1:46:46 下午"},"headers":[],"relativePath":"工作区/基本知识/JavaScript/注释细节.md"}'),l={name:"工作区/基本知识/JavaScript/注释细节.md"},o=p(`<p>#JavaScript #注释</p><h1 id="注释细节的笔记" tabindex="-1">注释细节的笔记 <a class="header-anchor" href="#注释细节的笔记" aria-hidden="true">#</a></h1><blockquote><p>目的：让编辑器给出提示 直接整代码</p></blockquote><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki"><code><span class="line"></span>
